---
title: "DATA 607: W10 Presentation - NLP, TFIDF Example"
...
list <- c("cParker", "dEllington", "jColtrane", "mDavis", 
...
```{r}
search <- c("famous","jazz", "saxophonist", "born", "kansas", "play", "bebop", "latin")
